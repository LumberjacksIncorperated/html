...
function getDateTags($text){
	echo("1");
	//$string = 
	$string = "curl -X POST \"https://api.dateparser.io/DMY/parse\" -H \"accept: application/json\" -H \"X-API-KEY: df60929ddd5df0859aceb28d881b67a3dae25d242febf70afd0d51fb280240f1\" -H \"Content-Type: application/json\" -d \"[".$text."]\"";
	echo("$string");
